 ...
 * 
 */
package com.veight.common.dao.impl;

import com.veight.common.dao.BaseDao;
import com.veight.common.entities.OrderEntity;
import com.veight.common.query.page.Filter;
import com.veight.common.query.page.Filter.Operator;
import com.veight.common.query.page.Order;
import com.veight.common.query.page.Order.Direction;
...
public abstract class BaseDaoImpl<T, ID extends Serializable> implements BaseDao<T, ID> {
    ...
    protected List<T> findList(CriteriaQuery<T> criteriaQuery, Integer first, Integer count, List<Filter> filters, List<Order> orders) {
        ...
        if (criteriaQuery.getOrderList()==null) {
    ...
    private void addOrders(CriteriaQuery<T> criteriaQuery, Pageable pageable) {
        ...
        System.out.println("criteriaQuery.getOrderList()######:" + criteriaQuery.getOrderList());
//        if (!criteriaQuery.getOrderList().isEmpty()) {
//            orderList.addAll(criteriaQuery.getOrderList());
//        }
